...
<section class="hero-web d-flex align-items-end dark-overlay bg-cover"
    style="background-image: url(img/photo/hero_bg2.png); background-size: 100% 100%;">
    ...
    <div>
        <div class="container ms-7">
            ...
            <ol class="breadcrumb ps-0 my-5 justify-content-start">
                <li class="breadcrumb-item text-lg"><a href="index.html">홈</a></li>
                <li class="breadcrumb-item text-lg"><a href="mypage.html">마이페이지</a></li>
        ...
        <div class="row mx-xl-7">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
                <div class="card shadow border-0 h-100"><a href="./restaurant_list.html"><img
                            class="img-fluid card-img-top" src="img/restarant_img.jpg" alt="..." /></a>
                    <div class="card-body">
                        <h2 class="my-2 text-center"><a class="text-dark" href="./restaurant_list.html">예약한 맛집</a>
                        </h2>
                    </div>
                </div>
            </div>
            <!-- blog item-->
            <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
                <div class="card shadow border-0 h-100"><a href="./lodging_list.html"><img
                            class="img-fluid card-img-top" src="img/photo/photo-1522771739844-6a9f6d5f14af.jpg"
                            alt="..." /></a>
                    <div class="card-body">
                        <h2 class="my-2 text-center"><a class="text-dark" href="./lodging_list.html">예약한 숙소
                            </a></h2>
                    </div>
                </div>
            </div>
            <!-- blog item-->
            <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
                <div class="card shadow border-0 h-100"><a href="./attractions_list.html"><img
                            class="img-fluid card-img-top" src="img/attractions.jpg" alt="..." /></a>
                    <div class="card-body">
                        <h2 class="my-2 text-center"><a class="text-dark" href="./attractions_list.html">예약한 액티비티
                                <br>
                            </a></h2>
                    </div>
                </div>
