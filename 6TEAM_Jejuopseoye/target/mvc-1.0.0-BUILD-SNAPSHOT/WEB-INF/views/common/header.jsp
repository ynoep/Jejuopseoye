      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="${path}/board/content/attraction?option=C1">관광지</a></li>
            <li class="nav-item"><a class="nav-link" href="${path}/board/content/attraction?option=C3">숙박</a></li>
            <li class="nav-item"><a class="nav-link" href="${path}/board/content/attraction?option=C4">음식점</a></li>
            <li class="nav-item"><a class="nav-link" href="${path}/board/content/attraction?option=C5">축제/행사</a></li>
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
            	<a class="nav-link" href="#">
            		<c:if test="${pattern}==0">
            			<c:if test="${cloud eq 'DB01'}">
            				<img src="${path}/resources/icons/sun.svg" alt="">
            			</c:if>
            			<c:if test="${cloud eq 'DB03'}">
            				<img src="${path}/resources/icons/cloud-sun.svg" alt="">
            			</c:if>
            			<c:if test="${cloud eq 'DB04'}">
            				<img src="${path}/resources/icons/cloud.svg" alt="">
            			</c:if>
            		</c:if>
            		<c:if test="${pattern}==1">
            			<img src="${path}/resources/icons/cloud-rain.svg" alt="">
            		</c:if>
            		<c:if test="${pattern}==2">
            			<c:if test="${temperatures}<=0">
            				<img src="${path}/resources/icons/cloud-snow.svg" alt="">
            			</c:if>
            			<c:if test="${temperatures}>0">
            				<img src="${path}/resources/icons/cloud-rain.svg" alt="">
            			</c:if>
