...
<section class="py-6">
	<div class="container">
		...
		<form action="${path}/board/free/update" method="post" enctype="multipart/form-data">
			<table
				...
				<tr>
					...
					<td><input class="py-4 text-center align-middle" style="width: 100%" type="text" name="title" value="${board.title}"></td>
				</tr>
				<tr>
					<th class="py-4 text-center align-middle">내용</th>
					<td>
						<textarea class="py-4 text-center align-middle" style="min-height: 400px; width: 100%;" name="content">${board.content}</textarea>
					</td>
				</tr>
				<tr>
					<td><input type="hidden" name="nickName" value="${loginMember.nickName}"></td>
					<td><input type="hidden" name="no" value="${board.no}"></td>
					<td><input type="hidden" name="type" value="free"></td>
				</tr>
				<tr>
				...
				<div class="position-relative">
					<div class="position-absolute end-0">
						...
						<button onclick="location.replace('${path}/board/free/board')" style="margin-left: 20px; margin-right: 20px" class="btn btn-dark" type="button">목록으로</button>
					</div>
				</div>
			</form>
		</div>
