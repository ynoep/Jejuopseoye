...
<section class="py-6">
	<div class="container">
		...
		<form action="${path}/board/free/board-write" method="post" enctype="multipart/form-data">
			<table
				...
				<tr>
					...
					<td><input class="py-4 text-center align-middle" style="width: 100%" type="text" name="title"></td>
				</tr>
				<tr>
					<th class="py-4 text-center align-middle">내용</th>
					<td>
						<textarea class="py-4 text-center align-middle" style="min-height: 400px; width: 100%;" name="content"></textarea></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="py-4 text-center align-middle"><input type="file" name="upfile"></td>
				</tr>
				</table>
				<div class="position-relative">
					<div class="position-absolute end-0">
						<button class="btn btn-primary" type="submit">등록</button>
						<button style="margin-left: 20px; margin-right: 20px" class="btn btn-dark" type="reset">취소</button>
					</div>
				</div>
			</form>
		</div>
