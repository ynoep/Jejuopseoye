...
<section class="py-6">
	<div class="container">
		...
		<form action="${path}/board/notice/update" method="post" enctype="multipart/form-data">
			<table
				...
				<div class="position-relative">
					<div class="position-absolute end-0">
						...
						<button onclick="location.replace('${path}/board/notice/board')" style="margin-left: 20px; margin-right: 20px" class="btn btn-dark" type="button">목록으로</button>
					</div>
				</div>
			</form>
		</div>
