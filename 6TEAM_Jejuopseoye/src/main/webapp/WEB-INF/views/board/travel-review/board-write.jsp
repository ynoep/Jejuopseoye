	...
	<section class="py-6">
		<div class="container">
			...
			<div class="table-responsive">
				<form action="${path}/board/travel-review/board-write" method="post"
					...
					<div class="position-relative">
						<div class="position-absolute end-0">
							...
							<button style="margin-left: 20px; margin-right: 20px"
								class="btn btn-dark" type="reset" onclick="history.back();">취소</button>
						</div>
					</div>
				</form>
			</div>
