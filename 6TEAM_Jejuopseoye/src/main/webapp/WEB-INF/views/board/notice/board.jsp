	...
	<section class="py-6">
						...
						<c:forEach var="board" items="${list}">
							<tr>
								...
								<td class="py-4 ps-5 align-middle"><a class="custom-a"
									href="${path}/board/notice/board-detail?no=${board.no}"><c:out
											value="${board.title}" /></a></td>
								<td class="py-4 text-center align-middle"><c:if
										test="${board.originalFileName != null }">
				...
				<ul
					...
					<li class="page-item">
						<button class="page-link"
							onclick="movePage('${path}/board/notice/board?type=notice&page=${pageInfo.prevPage}')">
					...
					<c:forEach begin="${pageInfo.startPage}" end="${pageInfo.endPage}"
						...
						<c:if test="${status.current != pageInfo.currentPage}">
							<li class="page-item">
								<button class="page-link"
									onclick="movePage('${path}/board/notice/board?type=notice&page=${status.current}')">
					...
					<li class="page-item">
						<button class="page-link"
							onclick="movePage('${path}/board/notice/board?type=notice&page=${pageInfo.nextPage}')">
		...
		<c:if
			...
			<div class="col-sm-11 pe-4" style="text-align: right;">
				<a href="${path}/board/notice/board-write"><button
