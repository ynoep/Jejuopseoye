			...
			<div class="row">
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CONT_000000000500281"> </a>
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000001195"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CONT_000000000500685"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
			...
			<div class="row">
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000022195"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000018491"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_200000000013928"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
			...
			<div class="row">
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000022220"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000001261"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CONT_000000000501303"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
			...
			<div class="row">
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000001321"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000018231"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
				...
				<div class="d-flex align-items-lg-stretch mb-4 col-lg-4">
					<div class="card shadow-lg border-0 w-100 border-0 hover-animate"
						...
						<a class="tile-link" href="${path}/board/content/board-detail?id=CNTS_000000000018122"> </a>
						<div class="d-flex align-items-center h-100 text-white justify-content-center py-6 py-lg-7">
